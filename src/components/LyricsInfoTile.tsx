...
/* trashCan 
md:h-fit md:flex-col md:gap-4 md:mx-auto md:w-1/2 md:aspect-square
md:w-full md:h-fit md:mx-auto
md:justify-end
md:absolute 
md:pb-2
*/
  ...
  return (
    lyricsDetails && (
      <div className={`flex md:flex-col justify-center items-center`}>
        <div className="w-[12rem] h-full aspect-square ">
          <img
        ...
        <div className="w-full h-full flex flex-col py-1 justify-around  text-white  inset-0 bg-transparent px-4  ">
          <div>
