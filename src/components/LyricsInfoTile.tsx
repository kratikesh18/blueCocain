...
const LyricsInfoTile = ({
  ...
  return (
    lyricsDetails && (
      <div className="relative h-[9rem] w-[90vw] flex items-center justify-center  shadow-2xl rounded-lg overflow-hidden md:h-fit md:flex-col md:gap-4 md:mx-auto md:w-1/2 md:aspect-square transition-transform transform hover:scale-105 hover:shadow-2xl">
        ...
        <div className="w-full h-full flex flex-col py-1 justify-around md:justify-end text-white  inset-0 bg-gradient-to-t from-black/80 to-gray-800/60 md:absolute px-4 md:pb-2 ">
          <div>
            ...
            <h2 className="text-lg">{lyricsDetails.albumName}</h2>
            <p className="text-sm">{lyricsDetails.genre}</p>
          </div>

          <div className="flex justify-between mt-4">
            <h3 className="text-lg ">{lyricsDetails.singer.name}</h3>
